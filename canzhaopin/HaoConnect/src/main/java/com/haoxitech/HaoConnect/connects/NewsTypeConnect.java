...
public class NewsTypeConnect extends HaoConnect {
    ...
    */
    ...
    {
        return request("news_type/columns", params, METHOD_GET, response, context);
    }
    ...
    */
    ...
    {
        return request("news_type/add", params, METHOD_POST, response, context);
    }
    ...
    */
    ...
    {
        return request("news_type/update", params, METHOD_POST, response, context);
    }
    ...
    */
    ...
    {
        return request("news_type/list", params, METHOD_GET, response, context);
    }
    ...
    */
    ...
    {
        return request("news_type/detail", params, METHOD_GET, response, context);
    }
