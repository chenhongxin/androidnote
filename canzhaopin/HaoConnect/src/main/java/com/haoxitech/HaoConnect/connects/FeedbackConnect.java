...
public class FeedbackConnect extends HaoConnect {
    ...
    */
    ...
    {
        return request("feedback/columns", params, METHOD_GET, response, context);
    }
    ...
    *                        content             string              *         
    *                        user_id             integer                       
    *                        status              integer                       0已删除  1.正常   2.草稿   3.待审
    ...
    */
    ...
    {
        return request("feedback/add", params, METHOD_POST, response, context);
    }
    ...
    */
    ...
    {
        return request("feedback/update", params, METHOD_POST, response, context);
    }
    ...
    */
    ...
    {
        return request("feedback/list", params, METHOD_GET, response, context);
    }
    ...
    */
    ...
    {
        return request("feedback/detail", params, METHOD_GET, response, context);
    }
