...
public class LaborTypeConnect extends HaoConnect {
    ...
    */
    ...
    {
        return request("labor_type/columns", params, METHOD_GET, response, context);
    }
    ...
    */
    ...
    {
        return request("labor_type/add", params, METHOD_POST, response, context);
    }
    ...
    */
    ...
    {
        return request("labor_type/update", params, METHOD_POST, response, context);
    }
    ...
    */
    ...
    {
        return request("labor_type/list", params, METHOD_GET, response, context);
    }
    ...
    */
    ...
    {
        return request("labor_type/detail", params, METHOD_GET, response, context);
    }
