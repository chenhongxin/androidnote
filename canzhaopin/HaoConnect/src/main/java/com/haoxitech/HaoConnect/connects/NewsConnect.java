...
public class NewsConnect extends HaoConnect {
    ...
    */
    ...
    {
        return request("news/columns", params, METHOD_GET, response, context);
    }
    ...
    * 新闻:新建
    * @param  params  参数
    *                        news_type_id        integer             *         新闻类型id
    *                        title               string              *         新闻标题
    *                        summary             string                        新闻摘要
    *                        picture             string              *         新闻图片
    *                        content             text                *         新闻内容
    *                        service_org_id      integer             *         发布机构
    *                        area_id             integer             *         新闻地区
    *                        view_count          integer                       浏览人数
    *                        status              integer                       状态：0-已删除，1-正常，2-草稿，3-待审
    *                        user_id             integer                       创建新闻用户id
    ...
    */
    ...
    {
        return request("news/add", params, METHOD_POST, response, context);
    }
    ...
    */
    ...
    {
        return request("news/update", params, METHOD_POST, response, context);
    }
    ...
    */
    ...
    {
        return request("news/list", params, METHOD_GET, response, context);
    }
    ...
    */
    ...
    {
        return request("news/detail", params, METHOD_GET, response, context);
    }
