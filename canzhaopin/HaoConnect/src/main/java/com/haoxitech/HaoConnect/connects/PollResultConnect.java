...
public class PollResultConnect extends HaoConnect {
    ...
    */
    ...
    {
        return request("poll_result/columns", params, METHOD_GET, response, context);
    }
    ...
    */
    ...
    {
        return request("poll_result/add", params, METHOD_POST, response, context);
    }
    ...
    */
    ...
    {
        return request("poll_result/update", params, METHOD_POST, response, context);
    }
    ...
    */
    ...
    {
        return request("poll_result/list", params, METHOD_GET, response, context);
    }
    ...
    */
    ...
    {
        return request("poll_result/detail", params, METHOD_GET, response, context);
    }
