...
public class UserFollowConnect extends HaoConnect {
    ...
    */
    ...
    {
        return request("user_follow/columns", params, METHOD_GET, response, context);
    }
    ...
    * 关注:新建
    * @param  params  参数
    *                        target_user_id      integer             *         被关注的目标id
    *                        status              integer                       状态：0-已删除，1-正常，2-草稿，3-待审
    *                        user_id             integer                       关注的用户id
    ...
    */
    ...
    {
        return request("user_follow/add", params, METHOD_POST, response, context);
    }
    ...
    */
    ...
    {
        return request("user_follow/update", params, METHOD_POST, response, context);
    }
    ...
    */
    ...
    {
        return request("user_follow/list", params, METHOD_GET, response, context);
    }
    ...
    */
    ...
    {
        return request("user_follow/detail", params, METHOD_GET, response, context);
    }
