...
public class PollConnect extends HaoConnect {
    ...
    */
    ...
    {
        return request("poll/columns", params, METHOD_GET, response, context);
    }
    ...
    * 投票评选:新建
    * @param  params  参数
    *                        poll_type           integer                       投票类型：1-单选，2-多选
    *                        max_num             integer                       最多选择多少项
    *                        poll_no             string                        投票编号
    *                        title               string              *         投票标题
    *                        picture             string                        投票图片
    *                        polled_count        integer                       投票人数
    ...
    */
    ...
    {
        return request("poll/add", params, METHOD_POST, response, context);
    }
    ...
    */
    ...
    {
        return request("poll/update", params, METHOD_POST, response, context);
    }
    ...
    */
    ...
    {
        return request("poll/list", params, METHOD_GET, response, context);
    }
    ...
    */
    ...
    {
        return request("poll/detail", params, METHOD_GET, response, context);
    }
