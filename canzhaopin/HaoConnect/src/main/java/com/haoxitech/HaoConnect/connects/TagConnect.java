...
public class TagConnect extends HaoConnect {
    ...
    */
    ...
    {
        return request("tag/columns", params, METHOD_GET, response, context);
    }
    ...
    */
    ...
    {
        return request("tag/add", params, METHOD_POST, response, context);
    }
    ...
    */
    ...
    {
        return request("tag/update", params, METHOD_POST, response, context);
    }
    ...
    */
    ...
    {
        return request("tag/list", params, METHOD_GET, response, context);
    }
    ...
    */
    ...
    {
        return request("tag/detail", params, METHOD_GET, response, context);
    }
