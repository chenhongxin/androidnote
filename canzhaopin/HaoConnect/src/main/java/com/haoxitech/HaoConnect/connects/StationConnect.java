...
public class StationConnect extends HaoConnect {
    ...
    */
    ...
    {
        return request("station/columns", params, METHOD_GET, response, context);
    }
    ...
    */
    ...
    {
        return request("station/add", params, METHOD_POST, response, context);
    }
    ...
    */
    ...
    {
        return request("station/update", params, METHOD_POST, response, context);
    }
    ...
    */
    ...
    {
        return request("station/list", params, METHOD_GET, response, context);
    }
    ...
    */
    ...
    {
        return request("station/detail", params, METHOD_GET, response, context);
    }
