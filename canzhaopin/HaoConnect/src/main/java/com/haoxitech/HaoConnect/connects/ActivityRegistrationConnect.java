...
public class ActivityRegistrationConnect extends HaoConnect {
    ...
    */
    ...
    {
        return request("activity_registration/columns", params, METHOD_GET, response, context);
    }
    ...
    */
    ...
    {
        return request("activity_registration/add", params, METHOD_POST, response, context);
    }
    ...
    */
    ...
    {
        return request("activity_registration/update", params, METHOD_POST, response, context);
    }
    ...
    */
    ...
    {
        return request("activity_registration/list", params, METHOD_GET, response, context);
    }
    ...
    */
    ...
    {
        return request("activity_registration/detail", params, METHOD_GET, response, context);
    }
