...
public class CrowdfundingAssistanceConnect extends HaoConnect {
    ...
    */
    ...
    {
        return request("crowdfunding_assistance/columns", params, METHOD_GET, response, context);
    }
    ...
    *                        assist_status       integer             *         援助状态：1-成功，2-失败
    *                        status              integer                       状态：0-已删除，1-正常，2-草稿，3-待审
    *                        user_id             integer                       援助用户id
    ...
    */
    ...
    {
        return request("crowdfunding_assistance/add", params, METHOD_POST, response, context);
    }
    ...
    */
    ...
    {
        return request("crowdfunding_assistance/update", params, METHOD_POST, response, context);
    }
    ...
    */
    ...
    {
        return request("crowdfunding_assistance/list", params, METHOD_GET, response, context);
    }
    ...
    */
    ...
    {
        return request("crowdfunding_assistance/detail", params, METHOD_GET, response, context);
    }
