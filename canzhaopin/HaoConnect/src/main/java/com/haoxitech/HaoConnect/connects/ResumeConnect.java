...
public class ResumeConnect extends HaoConnect {
    ...
    */
    ...
    {
        return request("resume/columns", params, METHOD_GET, response, context);
    }
    ...
    *                        username            string              *         姓名
    *                        sex                 integer             *         性别
    *                        expect_job          string              *         期待职位
    *                        expect_salary_min   integer             *         期望待遇最小金额  单价（元）
    *                        expect_salary_max   integer             *         期望待遇最大金额  单价（元）
    *                        experience          integer             *         工作经验
    *                        telephone           string              *         联系电话
    *                        card_number         string              *         残疾证编号
    *                        user_desc           string              *         自我描述
    *                        user_id             integer                       
    ...
    */
    ...
    {
        return request("resume/add", params, METHOD_POST, response, context);
    }
    ...
    */
    ...
    {
        return request("resume/update", params, METHOD_POST, response, context);
    }
    ...
    */
    ...
    {
        return request("resume/list", params, METHOD_GET, response, context);
    }
    ...
    */
    ...
    {
        return request("resume/detail", params, METHOD_GET, response, context);
    }
