...
public class WelfareConnect extends HaoConnect {
    ...
    */
    ...
    {
        return request("welfare/columns", params, METHOD_GET, response, context);
    }
    ...
    */
    ...
    {
        return request("welfare/add", params, METHOD_POST, response, context);
    }
    ...
    */
    ...
    {
        return request("welfare/update", params, METHOD_POST, response, context);
    }
    ...
    */
    ...
    {
        return request("welfare/list", params, METHOD_GET, response, context);
    }
    ...
    */
    ...
    {
        return request("welfare/detail", params, METHOD_GET, response, context);
    }
