 ...
 */
public class SmsManager extends ContentObserver {
    public static final String SMS_URI_INBOX = "content://sms/inbox";
    private Activity activity = null;
    private String smsContent = "";
    private EditText verifyText = null;

    public SmsManager(Activity activity, Handler handler, EditText verifyText) {
        super(handler);
    ...
    public void onChange(boolean selfChange) {
        ...
        try {
            ...
            cursor = activity.managedQuery(Uri.parse(SMS_URI_INBOX), new String[]{"_id", "address", "body", "read"}, "address=? and read=?",
                    new String[]{"1069053137", "0"}, "date desc");
