 ...
 */
public class MineJobAdapter extends BaseItemAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = LayoutInflater.from(context).inflate(R.layout.adapter_job, null);
            holder.jobImage = (ImageView) view.findViewById(R.id.job_image);
        ...
        try {
            FavoriteResult favoriteResult = (FavoriteResult) dataList.get(i);

            JobResult jobResult = (JobResult) favoriteResult.find("jobLocal");

            ImageLoader.getInstance().displayImage(jobResult.find("companyLocal>logo").toString(), holder.jobImage);
